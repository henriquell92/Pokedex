import 'package:MeuApp/src/pokemon.dart';
        ...
        top: MediaQuery.of(context).size.height * 0.1,
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Text("Fraquezas", style: TextStyle(fontWeight: FontWeight.bold),),
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              ...
              Text("Próximas Evoluções", style: TextStyle(fontWeight: FontWeight.bold),),
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceEvenly,
